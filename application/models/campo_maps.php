...
class CampoMaps extends Campo {
    ...
    protected function display($modo, $dato, $etapa_id) {
        ...
        if ($modo == 'edicion') {
            $display .= '<input id="' . $this->id . '" type="text" class="input-semi-large" name="' . $this->nombre . '" value="' . ($dato ? htmlspecialchars($dato->valor->address) : "") . '" data-modo="' . $modo . '" style="position: absolute; z-index: 2; margin: 10px;" />';
        }
    ...
    public function backendExtraFields() {
        ...
        if ($columns) {
            ...
            foreach ($columns as $key => $c) {
                $output .= '
                <tr>
                    <td><input type="text" name="extra[' . $i . '][latitude]" style="width:100px;" value="' . $c->latitude . '" /></td>
                    <td><input type="text" name="extra[' . $i . '][longitude]" style="width:100px;" value="' . $c->longitude . '" /></td>
                    <td><input type="text" name="extra[' . $i . '][address]" style="width:140px;" value="' . $c->address . '" /></td>
